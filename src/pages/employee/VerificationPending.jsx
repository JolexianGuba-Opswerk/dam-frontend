      ...
      <div className="w-full max-w-md bg-white rounded-xl shadow-md overflow-hidden">
        ...
        <div className="bg-blue-50 p-5 border-b border-blue-100 text-center">
          <div className="flex flex-col items-center justify-center">
            ...
            <h1 className="text-xl font-semibold text-gray-800">Verification Pending</h1>
        ...
        <div className="p-6">
          ...
          <div className="text-center text-xs text-gray-500 mb-6">
            ...
            <a href="mailto:support@devassets.com" className="text-blue-500 font-medium">support@devassets.com</a>
          </div>
